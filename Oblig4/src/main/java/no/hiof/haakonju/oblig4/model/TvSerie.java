package no.hiof.haakonju.oblig4.model;
...
public class TvSerie {
    ...
    public TvSerie(int tvSerieId, String tittel, String s, String s1, int i) {
        this.tittel = tittel;
    ...
    public boolean slettEpisode(int sesongNr, int episodeNr) {
        Episode episode = null;
        for (Episode e : episoder) {
            if (e.getSesongNummer() == sesongNr && e.getEpisodeNummer() == episodeNr) {
                episode = e;
                break;
            }
        }
