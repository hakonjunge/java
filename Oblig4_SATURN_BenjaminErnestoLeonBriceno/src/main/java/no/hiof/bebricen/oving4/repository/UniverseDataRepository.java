...
public class UniverseDataRepository implements UniverseRepository{
    ...
    public UniverseDataRepository() {
        ...
        PlanetSystem kepler11System  =
                new PlanetSystem("Kepler-11 System", kepler11, "http://bit.ly/2Iz4jPB");
    ...
    @Override
    public ArrayList<Planet> getAllPlanets(PlanetSystem planetSystem, String sortBy) {
        if (planetSystem.getPlanets(sortBy) != null){
            return planetSystem.getPlanets(sortBy);
        }
        return null;
    }

    @Override
    public Planet getPlanet(PlanetSystem planetSystem, String planet) {
        if (planetSystem.getPlanet(planet) != null){
            return planetSystem.getPlanet(planet);
        }
        return null;
    }
