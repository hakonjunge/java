package no.hiof.haakonju.oblig4.data;
...
public class TvSerie implements Comparable<TvSerie> {
    ...
    public URL getBildeUrl() {
        return bildeUrl;
    }

    public void setBildeUrl(URL bildeUrl) {
    ...
    public int compareTo(TvSerie other) {
        return this.tittel.compareTo(other.tittel);
    }
