...
<template id="episode-detail">
    <div v-if="episode" class="detail-episode-container">
        ...
        <div v-if="!episode.episodeNummerr" class="error">Episode må ha get-metode for "episodeNummerr"</div>
        ...
        <h1>S{{episode.sesongNummer}}E{{episode.episodeNr}} - {{episode.tittel}}</h1>
