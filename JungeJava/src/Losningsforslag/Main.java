...
// Lager og instansierer objektet strangerThings av typen TvSerie
        ...
        Film lotrtfotr = new Film("The Lord of the Rings: The Fellowship of the Ring", 178, );
        Film lotrtt = new Film("The Lord of the Rings: The Two Towers", 179);
        Film lotrrotk = new Film("The Lord of the Rings: The Return of the King", 201);
        String lotr1 = lotrtfotr.getTittel();
        String lotr2 = lotrtt.getTittel();
        String lotr3 = lotrrotk.getTittel();
